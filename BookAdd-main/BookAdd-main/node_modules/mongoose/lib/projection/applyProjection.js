...
const hasIncludedChildren = require('mongoose/lib/projection/hasIncludedChildren');
const isExclusive = require('mongoose/lib/projection/isExclusive');
const isInclusive = require('mongoose/lib/projection/isInclusive');
