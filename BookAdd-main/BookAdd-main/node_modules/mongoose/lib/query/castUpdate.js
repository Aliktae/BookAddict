...
const getEmbeddedDiscriminatorPath = require('mongoose/lib/query/getEmbeddedDiscriminatorPath');
const handleImmutable = require('mongoose/lib/query/handleImmutable');
const moveImmutableProperties = require('../update/moveImmutableProperties');
const schemaMixedSymbol = require('../../schema/symbols').schemaMixedSymbol;
const setDottedPath = require('mongoose/lib/path/setDottedPath');
